...
/*    */   {
/* 20 */     return new MouseButtonReleaseAction(left, middle, right);
/*    */   }
/*    */   
...
/*    */   public void execute()
/*    */   {
/* 47 */     robot.mouseRelease(this.buttons);
/*    */   }
/*    */   
/*    */   public String toString()
/*    */   {
/* 52 */     return "Release buttons: " + this.text;
/*    */   }
/*    */   
...
/*    */     
/* 60 */     int choice = JOptionPane.showConfirmDialog(parentComponent, mouseButtonPanel("Choose buttons to release", left, middle, right), parentComponent
/* 61 */       .getTitle(), 2);
/*    */     
/* 63 */     if (choice == 0) {
/*    */       try {
/* 65 */         return new MouseButtonReleaseAction(left.isSelected(), middle.isSelected(), right.isSelected());
