...
public class MouseButtonPressAction implements Action {
    ...
    public static MouseButtonPressAction showPopup(Frame parentComponent) {
        ...
        int choice = JOptionPane.showConfirmDialog(parentComponent, mouseButtonPanel("Choose buttons to press", left, middle, right), parentComponent.getTitle(), JOptionPane.OK_CANCEL_OPTION);
